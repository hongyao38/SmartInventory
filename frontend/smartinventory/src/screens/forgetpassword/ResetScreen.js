          ...
          <MDBRow rows="6" className="mb-5">
            <div className="d-flex flex-column  mt-4">
              <div className="text-center">
                <img src="/gold-key.png" style={{ width: "55px" }} alt="logo" />
                <h4 className="mt-2 mb-2 pb-2">
                  <strong>Set new password</strong>
                </h4>
                <h6> New password must be at least 8 characters long.</h6>
              </div>
              <br></br>
              <div className="mb-5">
              ...
              <MDBCol className="d-flex justify-content-center ">
                ...
                >
                  <div className={"d-flex justify-content-center"}>
                    ...
                    <div class="send-email-text">Reset Password</div>
                  </div>
                </button>
              </MDBCol>
            </div>
        ...
        <MDBModalDialog centered>
          <MDBModalContent>
            <div className="mt-4 text-center">
              <img src="/checked.png" style={{ width: "55px" }} alt="logo" />
            ...
            <div className="d-grid gap-2 col-5 mx-auto mb-4 mt-3">
              <MDBBtn onClick={() => handleBackToLogin()}>continue</MDBBtn>
            </div>
          </MDBModalContent>
        </MDBModalDialog>
      </MDBModal>
